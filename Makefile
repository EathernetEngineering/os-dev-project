...
CFLAGS := -g -m32 -nostdlib -nostdinc -fno-builtin -fno-stack-protector -nostartfiles -nodefaultlibs -I${CURDIR} -Wall -Wextra -Werror
...
debug: bin/os-image.bin kernel.elf
	qemu-system-i386 -s -S -fda bin/os-image.bin &
	${GDB} -ex "target remote localhost:1234" -ex "symbol-file kernel.elf"

run-vnc: bin/os-image.bin
	qemu-system-i386 -vnc :0 -fda bin/os-image.bin
